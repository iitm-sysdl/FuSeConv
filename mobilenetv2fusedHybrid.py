...
def MobileNetV2Friendly(num_classes=1000):
    return MobileNetV2Class(InvertedResidualFriendly, num_classes)

def MobileNetV2Friendly2(num_classes=1000):
    return MobileNetV2Class(InvertedResidualFriendly2, num_classes)
